...
(() => {
  ...
  const workspaceStyles = Object.freeze([
    ...
    ['/crump-precision-image-edit.css?v=5.9.76-lasso-invert-1', 'crumpprecisionimage'],
  ...
  const workspaceScripts = Object.freeze([
    ['/onboarding.js?v=5.9.76-local-photo-studio-guide-1', 'workspaceonboarding'],
    ...
    ['/chat-resilience.js?v=5.9.76-image-reference-recovery-1', 'workspacechatresilience'],
    ['/ui-functions.js?v=5.9.76-image-reference-recovery-1', 'workspaceui'],
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-precision-image-edit.js?v=5.9.76-lasso-invert-1', 'crumpprecisionimage'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-product-5.3.js?v=5.9.76-file-library-window-1', 'crumpproduct53'],
