...
(() => {
  ...
  const workspaceStyles = Object.freeze([
    ...
    ['/crump-5.0.css?v=5.9.76-reference-fidelity-focused-3', 'crump50'],
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-5.0.js?v=5.9.76-reference-fidelity-focused-3', 'crump50'],
    ['/crump-precision-image-edit-loader.js?v=5.9.76-reference-fidelity-focused-3', 'crumpprecisionloader'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-product-loader.js?v=5.9.76-reference-fidelity-focused-3', 'crumpproductloader'],
