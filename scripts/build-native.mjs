...
(() => {
  ...
  async function boot() {
    ...
    await loadStyle('/crump-product-5.3.css?v=5.9.76-project-routes-4', 'crumpproduct53');
    ...
    await loadScript('/crump-product-5.3.js?v=5.9.76-project-routes-4', 'crumpproduct53');
