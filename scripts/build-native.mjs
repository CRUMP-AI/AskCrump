...
(() => {
  ...
  const workspaceStyles = Object.freeze([
    ...
    ['/crump-precision-image-edit.css?v=5.9.76-precision-edit-studio-1', 'crumpprecisionimage'],
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-precision-image-edit.js?v=5.9.76-precision-edit-studio-1', 'crumpprecisionimage'],
