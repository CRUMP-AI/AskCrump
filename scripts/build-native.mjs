...
(() => {
  ...
  const workspaceStyles = Object.freeze([
    ...
    ['/crump-precision-image-edit.css?v=5.9.76-local-photo-studio-1', 'crumpprecisionimage'],
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-precision-image-edit.js?v=5.9.76-local-photo-studio-1', 'crumpprecisionimage'],
