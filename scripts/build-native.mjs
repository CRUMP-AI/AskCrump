...
(() => {
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-billing-5.1.js?v=5.9.76-project-limit-plan-dormant-1', 'billing51'],
    ['/crump-5.2.js?v=5.9.76-uploaded-image-node-stability-1', 'crump52'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-product-5.3.js?v=5.9.76-project-limit-plan-dormant-1', 'crumpproduct53'],
