...
const settingsProfileTrustVersion = `${releaseVersion}-settings-profile-trust-4`;
const settingsProfileTrustLoaderVersion = `${releaseVersion}-settings-profile-trust-loader-4`;
...
if (!serviceWorker.includes('ask-crump-new-body-v1-r194') ||
