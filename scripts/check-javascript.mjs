...
const settingsProfileTrustVersion = `${releaseVersion}-settings-profile-trust-6`;
const settingsProfileTrustLoaderVersion = `${releaseVersion}-settings-profile-trust-loader-6`;
...
if (!serviceWorker.includes('ask-crump-new-body-v1-r196') ||
