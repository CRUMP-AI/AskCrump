...
const settingsProfileTrustVersion = `${releaseVersion}-settings-profile-trust-5`;
const settingsProfileTrustLoaderVersion = `${releaseVersion}-settings-profile-trust-loader-5`;
...
if (!serviceWorker.includes('ask-crump-new-body-v1-r195') ||
