...
const landingVersion = `${releaseVersion}-attribution-registry-1`;
const authControllerVersion = `${releaseVersion}-login-failure-categories-1`;
...
const projectLimitPlanCandidateVersion = `${releaseVersion}-project-limit-plan-dormant-1`;
...
const requiredHtmlSignals = [
  `/runtime-body-v1.js?v=${projectLimitPlanCandidateVersion}`,
...
if (!runtime.includes('/billing.css') ||
    ...
    !runtime.includes(`/crump-product-5.3.js?v=${projectLimitPlanCandidateVersion}`) ||
...
if (runtimeDocument.documentElement.dataset.crumpBodyRuntime !== 'ready' ||
    ...
    loadedRuntimeScripts.indexOf(`/credit-confirmation.js?v=${creditConfirmationVersion}`) > loadedRuntimeScripts.indexOf(`/app.js?v=${creditConfirmationVersion}`) ||
    loadedRuntimeScripts.indexOf(`/app.js?v=${creditConfirmationVersion}`) > loadedRuntimeScripts.indexOf(`/crump-4.3.js?v=${intelligenceArchitectureVersion}`) ||
...
if (!serviceWorker.includes('ask-crump-new-body-v1-r221') ||
    ...
    !serviceWorker.includes(`/crump-product-5.3.js?v=${projectLimitPlanCandidateVersion}`) ||
