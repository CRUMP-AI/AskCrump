...
const settingsProfileTrustVersion = `${releaseVersion}-settings-profile-trust-7`;
const settingsProfileTrustLoaderVersion = `${releaseVersion}-settings-profile-trust-loader-7`;
...
if (!serviceWorker.includes('ask-crump-new-body-v1-r197') ||
