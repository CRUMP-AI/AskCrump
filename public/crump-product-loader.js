(() => {
  ...
  const STYLE_URL = '/crump-product-5.3.css?v=5.9.76-reference-review-persistence-1';
  const SCRIPT_URL = '/crump-product-5.3.js?v=5.9.76-reference-review-persistence-1';
