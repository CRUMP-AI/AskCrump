...
(() => {
  ...
  const assets = [
    ...
    ['style', '/crump-precision-image-edit.css?v=5.9.76-local-photo-studio-1', 'crumpprecisionimage'],
    ['script', '/crump-precision-image-edit.js?v=5.9.76-local-photo-studio-1', 'crumpprecisionimage'],
