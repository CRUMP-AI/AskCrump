...
(() => {
  ...
  const assets = [
    ...
    ['script', '/crump-5.0.js?v=5.9.76-composer-mode-reset-1', 'crump50'],
    ['style', '/crump-precision-image-edit.css?v=5.9.76-precision-studio-1', 'crumpprecisionimage'],
    ['script', '/crump-precision-image-edit.js?v=5.9.76-precision-studio-1', 'crumpprecisionimage'],
    ['style', '/crump-billing-5.1.css?v=5.9.76-credit-truth-1', 'billing51'],
    ['script', '/crump-billing-5.1.js?v=5.9.76-project-limit-plan-dormant-1', 'billing51'],
    ['style', '/crump-5.2.css', 'crump52'],
    ['script', '/crump-5.2.js?v=5.9.76-uploaded-image-node-stability-1', 'crump52'],
