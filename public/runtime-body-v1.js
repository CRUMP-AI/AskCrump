...
(() => {
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-billing-5.1.js?v=5.9.76-autonomous-activation-2', 'billing51'],
    ['/crump-5.2.js?v=5.9.76-autonomous-activation-2', 'crump52'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-navigation-5.9.30.js?v=5.9.76-autonomous-activation-2', 'crumpnav5930'],
    ['/crump-code-loader.js?v=5.9.76-autonomous-activation-2', 'crumpcodeloader'],
