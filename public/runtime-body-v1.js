...
(() => {
  ...
  const workspaceScripts = Object.freeze([
    ...
    ['/billing-manager.js?v=5.9.76-checkout-session-recovery-1', 'workspacebilling'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-product-5.3.js?v=5.9.76-button-ownership-1', 'crumpproduct53'],
    ['/crump-product-5.3.1.js?v=5.9.76-conversation-action-labels-1', 'crumpproduct531'],
