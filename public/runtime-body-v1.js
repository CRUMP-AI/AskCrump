...
(() => {
  ...
  const workspaceStyles = Object.freeze([
    ...
    ['/crump-precision-image-edit.css?v=5.9.76-precision-edit-studio-2', 'crumpprecisionimage'],
  ...
  const workspaceScripts = Object.freeze([
    ['/onboarding.js?v=5.9.76-precision-edit-guide-2', 'workspaceonboarding'],
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-5.0.js?v=5.9.76-precision-edit-handoff-2', 'crump50'],
    ['/crump-precision-image-edit.js?v=5.9.76-precision-edit-studio-2', 'crumpprecisionimage'],
