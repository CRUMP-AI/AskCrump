...
(() => {
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-billing-5.1.js?v=5.9.76-truthful-enterprise-positioning-1', 'billing51'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-subscriptions-5.3.2.js?v=5.9.76-truthful-enterprise-positioning-1', 'crumpsubscriptions532'],
