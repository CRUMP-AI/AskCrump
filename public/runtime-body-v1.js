...
(() => {
  ...
  const enhancementScripts = Object.freeze([
    ...
    ['/crump-billing-5.1.js?v=5.9.76-contextual-plan-recovery-1', 'billing51'],
    ['/crump-5.2.js?v=5.9.76-contextual-plan-recovery-1', 'crump52'],
  ...
  const finalScripts = Object.freeze([
    ...
    ['/crump-product-5.3.js?v=5.9.76-contextual-plan-recovery-1', 'crumpproduct53'],
    ...
    ['/crump-navigation-5.9.30.js?v=5.9.76-destination-focus-1', 'crumpnav5930'],
