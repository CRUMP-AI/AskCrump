(() => {
  ...
  const events = new Set(['WorkspaceOpened', 'StarterIntentReached', 'ActivationReached', 'OutcomeFeedbackSubmitted', 'RecentWorkResumed', 'PlanIntentReached', 'ResponseShared']);
