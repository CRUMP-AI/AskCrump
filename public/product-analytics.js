(() => {
  ...
  const events = new Set(['WorkspaceOpened', 'StarterIntentReached', 'ProjectSaveIntentReached', 'ActivationReached', 'OutcomeFeedbackSubmitted', 'OutcomeIssueCategorized', 'RecentWorkResumed', 'PlanCenterViewed', 'PlanIntentReached', 'ResponseShared']);
