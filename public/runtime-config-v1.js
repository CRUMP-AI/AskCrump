...
(() => {
  ...
  const assets = Object.freeze([
    ...
    ['style', '/crump-5.0.css?v=5.9.76-reference-fidelity-focused-3', 'crump50'],
    ['script', '/crump-5.0.js?v=5.9.76-reference-fidelity-focused-3', 'crump50'],
    ['script', '/crump-precision-image-edit-loader.js?v=5.9.76-reference-fidelity-focused-3', 'crumpprecisionloader'],
