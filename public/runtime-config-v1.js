...
(() => {
  ...
  const assets = Object.freeze([
    ...
    ['script', '/crump-5.0.js?v=5.9.76-reference-review-persistence-1', 'crump50'],
    ['script', '/crump-precision-image-edit-loader.js?v=5.9.76-precision-lazy-load-1', 'crumpprecisionloader'],
