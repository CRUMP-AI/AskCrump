...
(() => {
  ...
  const assets = Object.freeze([
    ...
    ['script', '/crump-5.0.js?v=5.9.76-project-save-offer-1', 'crump50'],
    ...
    ['script', '/crump-billing-5.1.js?v=5.9.76-checkout-destination-label-1', 'billing51'],
    ['style', '/crump-5.2.css', 'crump52'],
    ['script', '/crump-5.2.js?v=5.9.76-checkout-owner-reset-1', 'crump52'],
    ['style', '/crump-5.2.2.css?v=5.9.76-new-response-cue-1', 'crump522'],
    ['script', '/crump-5.2.2.js?v=5.9.76-checkout-owner-reset-1', 'crump522'],
    ['style', '/credit-confirmation.css?v=5.9.76-credit-confirmation-1', 'creditconfirmation'],
    ['script', '/credit-confirmation.js?v=5.9.76-checkout-owner-reset-1', 'creditconfirmation'],
