    ...
    *,
    ...
    if require_text:
        ...
        if suffix not in SAFE_TEXT_SUFFIXES and name not in SAFE_EXTENSIONLESS:
            raise ValueError("Autonomous Crump can only read and edit text source files in this release.")
...
async def run_with_deadline(
    ...
    *,
    ...
    try:
        ...
        raise CodeRunnerError("Autonomous Crump reached its execution deadline.", "CODE_DEADLINE") from exc
