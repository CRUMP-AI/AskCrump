-- Register the held Facebook rough-to-useful candidate without activating,
-- visiting, or publishing the campaign. Keep the browser, server, table
-- constraint, and AccountCreated RPC on one exact content-free vocabulary.
