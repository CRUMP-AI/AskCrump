-- Ask Crump 5.9.76
-- Remote ledger before release: 20260914210257. Release only the exact Facebook
-- organic Reel tuple for the sealed rough-to-useful creative. This migration
-- registers no visit, publication, campaign activation, or spend.
    ...
    or (
      ...
      and (
        ...
        or (
          source = 'facebook'
          and placement = 'organic-social'
          and creative = 'rough-to-useful-current-reel'
          and creative is not null
        )
        or (
          source = 'instagram'
...
begin
  ...
  if (
    ...
    or (
      ...
      and (
        ...
        or (
          v_acquisition = 'facebook'
          and v_placement = 'organic-social'
          and v_creative = 'rough-to-useful-current-reel'
          and v_creative is not null
        )
        or (
          v_acquisition = 'instagram'
    ...
    or (
      v_campaign = 'resume-bullet-truth-audit'
      and v_intent = 'resume'
      and v_acquisition = 'organic-search'
      and v_placement = 'workflow-guide'
      and v_creative = 'search-article'
