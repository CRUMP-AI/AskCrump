-- Ask Crump 5.9.16
-- Add a content-free recent-work continuation milestone to the private product journey.
...
comment on function public.product_growth_funnel_snapshot(
  ...
  'Service-role-only aggregate growth funnel with recent-work continuation and binary outcome feedback. Returns counts and rates, never account identifiers or user content.';
