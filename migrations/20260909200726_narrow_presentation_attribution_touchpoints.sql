-- Narrow Presentation attribution to the four truthful routes used by the
-- approved campaign package. Retire ig-feed as a direct attribution label:
-- the Instagram feed caption points to a shared profile link and therefore
-- cannot identify one specific feed asset.
  ...
  add constraint product_events_campaign_registry_check check (
    ...
    or (
      ...
      and (
        ...
        or (source = 'facebook' and placement = 'organic-social' and creative = 'fb-static')
        or (source = 'instagram' and placement = 'organic-social' and creative = 'ig-story')
      )
    )
    or (
  ...
  if not (
    (
      ...
      and (
        ...
        or (v_acquisition = 'facebook' and v_placement = 'organic-social' and v_creative = 'fb-static')
        or (v_acquisition = 'instagram' and v_placement = 'organic-social' and v_creative = 'ig-story')
      )
    )
    or (
