-- Register one dormant Facebook paid-learning attribution route without
-- activating traffic or widening the existing organic route. Keep the two
-- rough-to-useful touchpoints explicit so their fields cannot cross-product.

begin;

alter table public.product_events
  drop constraint if exists product_events_account_acquisition_check;
...
alter table public.product_events
  validate constraint product_events_account_acquisition_check;

alter table public.product_events
  drop constraint if exists product_events_placement_check;
...
alter table public.product_events
  validate constraint product_events_placement_check;
