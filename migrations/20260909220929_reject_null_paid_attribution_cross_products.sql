-- Close PostgreSQL three-valued-logic gaps in campaign validation. A
-- registered campaign must match a complete allowlisted tuple; NULL fields
-- cannot make a CHECK expression pass or bypass writer normalization.
