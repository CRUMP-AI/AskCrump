...
Cancellation prevents a queued task from starting and records the decision. A running sandbox
is also bounded by its execution deadline and destruction-on-exit contract. The initial release
