...
def test_project_reference_ui_and_chat_rename_are_final_runtime_layers():
    ...
    assert "/crump-product-5.3.1.js?v=5.9.76-conversation-action-labels-1" in runtime
    assert "/crump-product-5.3.1.js?v=5.9.76-conversation-action-labels-1" in worker
