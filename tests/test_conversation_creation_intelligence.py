...
def test_conversation_intelligence_advances_shell_cache():
    ...
    assert "ask-crump-new-body-v1-r197" in sw
    assert "ask-crump-new-body-v1-r23" not in sw
    assert "ask-crump-new-body-v1-r197" in checker
...
def test_reload_opens_a_clean_conversation_without_discarding_history():
    ...
    assert "['/app.js?v=5.9.76-settings-profile-trust-7', 'workspaceapp']" in runtime
    assert "'/app.js?v=5.9.76-settings-profile-trust-7'" in worker
