...
def test_conversation_intelligence_advances_shell_cache():
    ...
    assert "ask-crump-new-body-v1-r250" in sw
    assert "CACHE_NAME = 'ask-crump-new-body-v1-r229'" not in sw
    assert "ask-crump-new-body-v1-r250" in checker
...
def test_reload_opens_a_clean_conversation_without_discarding_history():
    ...
    assert "['/app.js?v=5.9.76-reference-fidelity-focused-1', 'workspaceapp']" in runtime
    assert "'/app.js?v=5.9.76-reference-fidelity-focused-1'" in worker
