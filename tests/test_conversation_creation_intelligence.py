...
def test_conversation_intelligence_advances_shell_cache():
    ...
    assert "ask-crump-new-body-v1-r194" in sw
...
def test_reload_opens_a_clean_conversation_without_discarding_history():
    ...
    assert "['/app.js?v=5.9.76-settings-profile-trust-4', 'workspaceapp']" in runtime
    assert "'/app.js?v=5.9.76-settings-profile-trust-4'" in worker
