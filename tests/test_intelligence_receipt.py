...
def test_intelligence_receipt_assets_are_cache_versioned_atomically():
    ...
    loader_version = "5.9.76-settings-profile-trust-loader-2"
    ...
    for source in (runtime, worker):
        assert "/app.js?v=5.9.76-settings-profile-trust-2" in source
    assert "ask-crump-new-body-v1-r192" in worker
