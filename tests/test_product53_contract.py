...
def test_product53_runtime_is_registered_last_and_cached():
    ...
    assert "/crump-product-5.3.js?v=5.9.76-project-limit-plan-dormant-1" in runtime
    assert "/crump-product-5.3.js?v=5.9.76-project-limit-plan-dormant-1" in worker
