...
def test_product53_runtime_is_lazy_loaded_and_cache_addressable():
    ...
    assert "/crump-product-loader.js?v=5.9.76-reference-review-persistence-1" in runtime
    assert "/crump-product-loader.js?v=5.9.76-reference-review-persistence-1" in worker
    assert "/crump-product-5.3.css?v=5.9.76-reference-review-persistence-1" not in runtime
    assert "/crump-product-5.3.js?v=5.9.76-reference-review-persistence-1" not in runtime
    assert "/crump-product-5.3.css?v=5.9.76-reference-review-persistence-1" not in worker
    assert "/crump-product-5.3.js?v=5.9.76-reference-review-persistence-1" not in worker
    assert "/crump-product-5.3.css?v=5.9.76-reference-review-persistence-1" in loader
    assert "/crump-product-5.3.js?v=5.9.76-reference-review-persistence-1" in loader
