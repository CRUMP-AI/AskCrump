...
def test_monetization_measurement_assets_are_registered_for_web_pwa_and_native():
    credit_truth_version = "5.9.76-autonomous-activation-2"
    attach_creation_version = "5.9.76-autonomous-activation-2"
    loader_version = "5.9.76-autonomous-activation-2"
