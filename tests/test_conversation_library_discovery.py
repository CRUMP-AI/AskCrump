...
def test_chats_is_an_ask_utility_instead_of_a_competing_active_destination():
    ...
    assert "Chats is Ask's conversation drawer, not a competing product destination." in styles
