...
def test_contextual_recovery_assets_are_registered_for_web_pwa_and_native():
    ...
    durable_project_version = "5.9.76-durable-project-recognition-1"
    ...
    assert f"/crump-product-5.3.js?v={durable_project_version}" in runtime
    assert f"/crump-product-5.3.js?v={durable_project_version}" in worker
