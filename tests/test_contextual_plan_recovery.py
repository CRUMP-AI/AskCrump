...
def test_contextual_recovery_assets_are_registered_for_web_pwa_and_native():
    ...
    canonical_files_version = "5.9.76-canonical-files-handoff-1"
    ...
    assert f"/crump-product-5.3.js?v={canonical_files_version}" in runtime
    assert f"/crump-product-5.3.js?v={canonical_files_version}" in worker
    assert "ask-crump-new-body-v1-r152" in worker
