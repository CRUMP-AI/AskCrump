...
def test_parallel_runtime_asset_is_versioned_for_web_pwa_and_native():
    ...
    asset = "/runtime-body-v1.js?v=5.9.76-reference-fidelity-1"
...
def test_returning_workspace_uses_precache_without_staling_the_shell():
    ...
    assert "/crump-product-loader.js?v=5.9.76-reference-fidelity-1" in verifier
...
def test_returning_workspace_activation_upgrade_uses_current_exact_fixture_proof():
    ...
    assert "ask-crump-new-body-v1-r255" in worker
    assert "/runtime-body-v1.js?v=5.9.76-reference-fidelity-1" in worker
...
def test_reference_fidelity_upgrade_replaces_r254_without_precaching_product_studio():
    verifier = read("scripts/verify-reference-fidelity-cache-upgrade.cjs")
    matrix = read("scripts/verify-browser-control-matrix.mjs")

    assert "ask-crump-new-body-v1-r254" in verifier
    assert "ask-crump-new-body-v1-r255" in verifier
    assert "/runtime-body-v1.js?v=5.9.76-reference-fidelity-1" in verifier
    assert "/crump-5.0.js?v=5.9.76-reference-fidelity-1" in verifier
    assert "/crump-product-loader.js?v=5.9.76-reference-fidelity-1" in verifier
    assert "/crump-product-5.3.js?v=5.9.76-reference-fidelity-1" in verifier
