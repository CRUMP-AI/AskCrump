...
def test_retired_tool_assets_are_cache_versioned_atomically():
    loader_version = "5.9.76-owner-isolation-1"
    product_loader_version = "5.9.76-product-studio-video-owner-1"
    shell = read("public/app.html")
    ...
    for source in (runtime, worker, native):
        ...
        assert "/crump-product-5.3.js?v=5.9.76-video-owner-isolation-1" not in source
