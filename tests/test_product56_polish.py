...
def test_56_polish_layer_is_last_on_web_and_native():
    ...
    assert "ask-crump-new-body-v1-r247" in worker
...
def test_authenticated_workspace_stays_behind_a_bounded_runtime_gate():
    ...
    assert '<link rel="preload" as="image" type="image/webp" href="/assets/brand/crump-mark-320.webp" fetchpriority="high">' in page
    ...
    assert "document.head.appendChild(existing);" not in runtime
