...
def test_plan_center_containment_assets_are_versioned_everywhere():
    ...
    versioned_credit_contract = "/crump-5.2.2.js?v=5.9.76-checkout-session-recovery-1"
    sources = (
        read_public("runtime-body-v1.js"),
        read_public("sw.js"),
    ...
    assert "ask-crump-new-body-v1-r233" in read_public("sw.js")
    assert "/runtime-body-v1.js?v=5.9.76-conversation-action-labels-2" in read_public("app.html")
