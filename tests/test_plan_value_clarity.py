...
def test_plan_center_containment_assets_are_versioned_everywhere():
    ...
    versioned_final = "/crump-5.2.js?v=5.9.76-checkout-owner-reset-1"
    versioned_billing_css = "/crump-billing-5.1.css?v=5.9.76-credit-truth-1"
    versioned_credit_contract = "/crump-5.2.2.js?v=5.9.76-checkout-owner-reset-1"
    sources = (
        read_public("runtime-body-v1.js"),
        read_public("sw.js"),
    ...
    assert "/runtime-body-v1.js?v=5.9.76-checkout-owner-reset-1" in read_public("app.html")
