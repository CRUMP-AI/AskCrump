...
def test_plan_center_containment_assets_are_versioned_everywhere():
    versioned_billing = "/crump-billing-5.1.js?v=5.9.76-autonomous-activation-2"
    versioned_final = "/crump-5.2.js?v=5.9.76-autonomous-activation-2"
    ...
    assert "/runtime-body-v1.js?v=5.9.76-autonomous-activation-2" in read_public("app.html")
