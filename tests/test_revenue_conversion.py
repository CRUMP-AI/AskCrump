...
def test_marketing_ctas_are_first_party_analytics_events():
    ...
    assert '<script defer src="/landing.js?v=5.9.76-image-intent-handoff-1"></script>' in page
...
def test_public_marketing_surface_is_indexable_while_the_private_app_is_not():
    ...
    assert sitemap.count("<lastmod>2026-09-10</lastmod>") == 2
    ...
    assert urls == {
        ...
        "https://www.askcrump.com/guides/audit-ai-resume-bullets": "2026-09-10",
...
def test_release_version_and_cache_advance_together():
    ...
    assert "/landing.js?v=5.9.76-image-intent-handoff-1" in worker
